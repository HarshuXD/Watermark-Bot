...
class Config(object):
	...
	CAPTION = "By @VIDEOWATERMARKROBOT"
...
__Note: I can only process one video at a time. As my server is Heroku, my health is not good. If you have any issues with Adding Watermark to a Video, then please Report [HERE](https://t.me/harshu_xd)\n\nSend /settings To Modify your watermark.__
