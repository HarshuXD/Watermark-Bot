...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Harshu_xD"), InlineKeyboardButton("Support", url="https://t.me/Harshu_xD")], [InlineKeyboardButton("Powered By", url="https://t.me/StarterMods")], [InlineKeyboardButton("Movie Group", url="https://t.me/StarterMovie")]]),
	...
	if "refreshmeh" in cb_data:
		if Config.UPDATES_CHANNEL:
			...
			try:
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [ Boss ](https://t.me/Harshu_xD).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/harshu_xd"), InlineKeyboardButton("Support", url="https://t.me/Harshu_xD")], [InlineKeyboardButton("Powered By", url="https://t.me/StarterMods")]]),
			disable_web_page_preview=True
		)
		...
		if Config.UPDATES_CHANNEL:
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [ BOSS ](https://t.me/HARSHU_XD).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
